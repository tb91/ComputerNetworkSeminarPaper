...
Durch die Eckpunkte aller Dreiecke wird ein Kreis gebildet.
Genau dann, wenn in einem Umkreis kein Punkt des Graphen enthalten ist, sind diese drei Kanten im Delaunay Graphen vorhanden.
