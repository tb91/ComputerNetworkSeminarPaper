...
\caption{Punkt A mit acht $45\degree $ großen Kegeln. Kürzeste Kante $AB $ wird ausgewählt}
\label{fig:YaoStep2}
\end{figure}
...
Gegeben sind zwei Kanten $CA $ und $CB $ ausgehend von einem gemeinsamen Punkt $C $.
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.80\linewidth]{outward_path1.eps}
\caption{}
