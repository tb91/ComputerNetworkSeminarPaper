...
\caption{Auswahl der Kanten $AB $, $AD $ und $AF $ und Nummerierung der Kanten und Kegel.}
...
Kegel $4 $ ist beginnend von $1 $ der erste leere Kegel.
Da zwischen $4 $ und $8 $ keine Kegel existieren, welche einen Knoten enthalten, werden dieses zusammengefasst und als ein Iterationsschritt interpretiert.
...
Da momentan $l=5 $ ist (von 4 bis 8), wird Fall 1 ausgeführt.
