...
Der Beispiel Graph $E $, welchen wir für dieses Beispiel verwenden, ist in Abbildung \ref zu sehen.
Daraus wird zuerst der Delaunay Graph gebildet.
Durch die Eckpunkte aller Dreiecke wird zunächst ein Kreis gebildet.
Genau dann, wenn in einem Umkreis kein Punkt des Graphen enthalten ist, sind diese drei Kanten auch im Delaunay Graphen.
