...
$CA $ ist die kürzeste Kante.
Nun benutzen die Autoren von \cite{kanj} eine rekursive Definition um den Pfad von A nach B zu definieren.
Wenn dieser Pfad nicht existiert, ist der Graph nicht mehr verbunden.
Die Rekursion endet, wenn $AB \in G$.
In diesem Fall




 (Abbildung \ref{fig:outward_path1}).
\begin{figure}[h!]
\centering
