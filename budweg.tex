...
Um den Pfad von A nach B zu erhalten, wird ein Pfad von A zum intermediate Point T (für Konstruktion siehe Abbildung \ref{fig:intermediate}) und von diesem zu B erstellt und konkateniert.
